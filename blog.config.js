...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是路非,致力于AIGC落地电商商业应用,帮助企业快速降本增效,欢迎你来了解路非的AIGC课程,这是套上午学下午就帮电商企业降本增效的AIGC体系优秀课程🎉，点击下方分栏即可了解或试看课程',
