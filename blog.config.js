...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，欢迎来了解路非的AIGC课程,这是套上午学下午就帮电商企业降本增效的课程，点击下方栏目即可了解与试看课程🎉',
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '路非 X , AIGC课程', // 网站关键词 英文逗号隔开
